...
class AdyenApiFlutter {
  ...
  Future<void> dispose() {
    return AdyenApiFlutterPlatform.instance.dispose();
  }

  Future<Map<dynamic, dynamic>> paymentRequest(double amount, String POIID,
      {String saleID = "001"}) {
    return AdyenApiFlutterPlatform.instance
        .paymentRequest(amount, POIID, saleID);
  }
  ...
  Future<Map<dynamic, dynamic>> statusRequest(String transactionServiceID,
      MessageCategoryType statusRequestType, String POIID,
      {String saleID = "001"}) {
    return AdyenApiFlutterPlatform.instance
